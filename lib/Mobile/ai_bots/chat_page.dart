...
import 'package:flemini/Mobile/ai_bots/ai_controller.dart';
...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({super.key, this.aiPrompt});
...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    AIController controller = Get.put(AIController(userId: userId));
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (value) {
                        controller.sendPrompt(text: value, prompt: '');
                        textField.clear();
                      },
